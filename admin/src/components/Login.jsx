  ...
  return (
    <div className='min-h-screen flex items-center justify-center w-full'>
      <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
        <h1 className='text-[#c2410c] mb-4 font-bold text-2xl'>Admin Panel</h1>
        <form onSubmit={onSubmitHandler}>
          <div className='mb-3 min-w-72'>
            <p className='text-sm font-medium text-[#c2410c] mb-2'>Email Address</p>
          ...
          <div className='mb-3 min-w-72'>
            <p className='text-sm font-medium text-[#c2410c] mb-2'>Password</p>
          ...
          <button className='mt-2 cursor-pointer w-full py-2 px-4 rounded-md text-white bg-[#c2410c]' type='submit'>Login</button>
        </form>
      </div>
    </div>
  )
