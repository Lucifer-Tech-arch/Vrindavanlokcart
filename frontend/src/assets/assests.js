...
export const products = [
    ...
    },
    {
        _id: 'aaaac',
        name: 'Key Rings',
        description: 'Believed to bring protection, prosperity, and positivity, this keychain can be used for your car keys, bike keys, bag, or even as a charm. A thoughtful gift for Krishna devotees, it’s ideal for Janmashtami, birthday returns, temple souvenirs, or spiritual keepsakes.',
        price:76,
        image: [keyrings],
